					...
					<div class="doctors-slider owl-carousel aos" data-aos="fade-up">
						<div class="card">
							<div class="card-img card-img-hover">
								<a href="doctor-profile.html"><img src="{{ asset('backend/assets/img/doctor-grid/doctor-grid-01.jpg') }}" alt=""></a>
						...
						<div class="card">
							<div class="card-img card-img-hover">
								<a href="doctor-profile.html"><img src="{{ asset('backend/assets/img/doctor-grid/doctor-grid-02.jpg') }}" alt=""></a>
								<div class="grid-overlay-item d-flex align-items-center justify-content-between">
						...
						<div class="card">
							<div class="card-img card-img-hover">
								<a href="doctor-profile.html"><img src="{{ asset('backend/assets/img/doctor-grid/doctor-grid-03.jpg') }}" alt=""></a>
								<div class="grid-overlay-item d-flex align-items-center justify-content-between">
						...
						<div class="card">
							<div class="card-img card-img-hover">
								<a href="doctor-profile.html"><img src="{{ asset('backend/assets/img/doctor-grid/doctor-grid-04.jpg') }}" alt=""></a>
								<div class="grid-overlay-item d-flex align-items-center justify-content-between">
									<span class="badge bg-orange"><i class="fa-solid fa-star me-1"></i>4.8</span>
									<a href="javascript:void(0)" class="fav-icon">
										<i class="fa fa-heart"></i>
						...
						<div class="card">
							<div class="card-img card-img-hover">
								<a href="doctor-profile.html"><img src="{{ asset('backend/assets/img/doctor-grid/doctor-grid-05.jpg') }}" alt=""></a>
								<div class="grid-overlay-item d-flex align-items-center justify-content-between">
