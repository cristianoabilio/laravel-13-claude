            ...
            <div class="dashboard-card flex-fill">
                ...
                <div class="dashboard-card-body">
                    <div class="doctor-fav-list">
                        <div class="doctor-info-profile">
                            <a href="#" class="table-avatar">
                                <img src="{{ asset('backend/assets/img/patients/patient-20.jpg') }}" alt="Img">
                            </a>
                            <div class="doctor-name-info">
                    ...
                    <div class="doctor-fav-list">
                        <div class="doctor-info-profile">
                            <a href="#" class="table-avatar">
                                <img src="{{ asset('backend/assets/img/patients/patient-21.jpg') }}" alt="Img">
                            </a>
                            <div class="doctor-name-info">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <h2 class="table-avatar">
                                                        <a href="doctor-profile.html" class="avatar avatar-sm me-2">
                                                            <img class="avatar-img rounded-3" src="{{ asset('backend/assets/img/doctors/doctor-thumb-22.jpg') }}" alt="User Image">
                                                        </a>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <h2 class="table-avatar">
                                                        <a href="doctor-profile.html" class="avatar avatar-sm me-2">
                                                            <img class="avatar-img rounded-3" src="{{ asset('backend/assets/img/doctors/doctor-thumb-25.jpg') }}" alt="User Image">
                                                        </a>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <h2 class="table-avatar">
                                                        <a href="doctor-profile.html" class="avatar avatar-sm me-2">
                                                            <img class="avatar-img rounded-3" src="{{ asset('backend/assets/img/doctors/doctor-thumb-26.jpg') }}" alt="User Image">
                                                        </a>
                                            ...
                                            <tbody>
                                                    ...
                                                    <td>
                                                        <h2 class="table-avatar">
                                                            <a href="paitent-details.html" class="avatar avatar-sm me-2">
                                                                <img class="avatar-img rounded-3" src="{{ asset('backend/assets/img/doctors-dashboard/profile-06.jpg') }}" alt="User Image">
                                                            </a>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <h2 class="table-avatar">
                                                            <a href="paitent-details.html" class="avatar avatar-sm me-2">
                                                                <img class="avatar-img rounded-3" src="{{ asset('backend/assets/img/dependent/dependent-01.jpg') }}" alt="User Image">
                                                            </a>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <h2 class="table-avatar">
                                                            <a href="paitent-details.html" class="avatar avatar-sm me-2">
                                                                <img class="avatar-img rounded-3" src="{{ asset('backend/assets/img/dependent/dependent-02.jpg') }}" alt="User Image">
                                                            </a>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <h2 class="table-avatar">
                                                            <a href="paitent-details.html" class="avatar avatar-sm me-2">
                                                                <img class="avatar-img rounded-3" src="{{ asset('backend/assets/img/dependent/dependent-03.jpg') }}" alt="User Image">
                                                            </a>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <h2 class="table-avatar">
                                                            <a href="paitent-details.html" class="avatar avatar-sm me-2">
                                                                <img class="avatar-img rounded-3" src="{{ asset('backend/assets/img/dependent/dependent-04.jpg') }}" alt="User Image">
                                                            </a>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <h2 class="table-avatar">
                                                            <a href="doctor-profile.html" class="avatar avatar-sm me-2">
                                                                <img class="avatar-img rounded-3" src="{{ asset('backend/assets/img/doctors/doctor-thumb-05.jpg') }}" alt="User Image">
                                                            </a>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <h2 class="table-avatar">
                                                            <a href="doctor-profile.html" class="avatar avatar-sm me-2">
                                                                <img class="avatar-img rounded-3" src="{{ asset('backend/assets/img/doctors/doctor-thumb-03.jpg') }}" alt="User Image">
                                                            </a>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <h2 class="table-avatar">
                                                            <a href="doctor-profile.html" class="avatar avatar-sm me-2">
                                                                <img class="avatar-img rounded-3" src="{{ asset('backend/assets/img/doctors/doctor-thumb-08.jpg') }}" alt="User Image">
                                                            </a>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <h2 class="table-avatar">
                                                            <a href="doctor-profile.html" class="avatar avatar-sm me-2">
                                                                <img class="avatar-img rounded-3" src="{{ asset('backend/assets/img/doctors/doctor-thumb-01.jpg') }}" alt="User Image">
                                                            </a>
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <h2 class="table-avatar">
                                                            <a href="doctor-profile.html" class="avatar avatar-sm me-2">
                                                                <img class="avatar-img rounded-3" src="{{ asset('backend/assets/img/doctors/doctor-thumb-21.jpg') }}" alt="User Image">
                                                            </a>
                                                            <a href="doctor-profile.html">Edalin Hendry</a>
                                                        </h2>
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <h2 class="table-avatar">
                                                            <a href="doctor-profile.html" class="avatar avatar-sm me-2">
                                                                <img class="avatar-img rounded-3" src="{{ asset('backend/assets/img/doctors/doctor-thumb-13.jpg') }}" alt="User Image">
                                                            </a>
                                                            <a href="doctor-profile.html">John Homes</a>
                                                        </h2>
                                                    </td>
